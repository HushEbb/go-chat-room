...
type ChatMessage struct {
	...
	Id             uint64                 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"` // 对应于model.Message.ID (使用uint64以获得更广泛的兼容性)
	Content        string                 `protobuf:"bytes,2,opt,name=content,proto3" json:"content,omitempty"`
	SenderId       uint64                 `protobuf:"varint,3,opt,name=sender_id,json=senderId,proto3" json:"sender_id,omitempty"`
	ReceiverId     uint64                 `protobuf:"varint,4,opt,name=receiver_id,json=receiverId,proto3" json:"receiver_id,omitempty"` // 0表示广播
...
func (x *ChatMessage) GetReceiverId() uint64 {
	if x != nil {
		return x.ReceiverId
	}
	return 0
...
func (x *ChatMessage) GetSenderAvatar() string {
	if x != nil {
...
func (x *ClientToServerMessage) GetContent() string {
	if x != nil {
		return x.Content
	}
	return ""
...
func (x *ClientToServerMessage) GetReceiverId() uint64 {
	if x != nil {
		return x.ReceiverId
	}
	return 0
...
var file_message_proto_goTypes = []any{
	...
	(*ClientToServerMessage)(nil), // 1: proto.ClientToServerMessage
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_message_proto_depIdxs = []int32{
	2, // 0: proto.ChatMessage.created_at:type_name -> google.protobuf.Timestamp
